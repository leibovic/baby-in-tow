      ...
      <div className="welcomePage">
        ...
        <section className="better">
          ...
          <div className="welcomeSectionParagraph">
            We scout local businesses and crowdsource baby-tips from other
            parents to bring you the best things to do in your neighbourhood
        ...
        <section className="out-there">
          ...
          <div className="welcomeSectionParagraph">
            Even with sleep deprivation, fresh air is good for the soul. Our
            goal is to make it easier for you and baby to get out and enjoy
            yourselves.
          </div>
          <div className="categorySections">
            ...
            <div className="categorySection">
              ...
              <div className="categoryDescription">
                Places to go for some &quot;me&quot; time - curated for
                businesses that welcome your baby too.
              </div>
            </div>
            <div className="categorySection">
